...
Please have a look at the [example test](https://github.com/christian-draeger/basic-selenium-project/blob/master/src/test/java/tests/template/ExampleTemplateIT.kt)
